        ...
        return (
            <div className="config-panel">
                ...
                <Row className="shelf">
                    ...
                    <Col span={16}>
                        <Select className="select-box" defaultValue={fact.focus.length ? fact.focus[0].value : ''} value={fact.focus.length ? fact.focus[0].value : ''} size='small' onChange={handleFocusChange}>
                            {gbValueList[0] !== undefined && gbValueList.map((key) => <Option key={key} value={key}>{key}</Option>)}
                        </Select>
                    </Col>
                </Row>
                ...
                {/* {!fact.focus.length && displayFocus} */}
